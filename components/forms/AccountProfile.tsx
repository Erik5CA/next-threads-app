...
import { UserSchema, UserValidation } from "@/lib/validations/user";
...
const AccountProfile = ({ user, btnTitle }: Props) => {
  ...
  const { startUpload, isUploading } = useUploadThing("uploadImage");
  ...
  const onSubmit = async (formData: UserSchema) => {
    ...
    if (hasImageChanged) {
      ...
      if (imgRes && imgRes[0].url) {
        formData.profile_photo = imgRes[0].url;
      }
    }
    ...
    <Form {...form}>
      ...
      >
        <div className="text-gray-200">
          <h2 className="text-heading4-medium">Your Profile</h2>
